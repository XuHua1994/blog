...
<body>
	...
	<div class="easyui-layout" style="height: 95%; border: 1px;">
		<div style="height: 35px; font-size: 18px; color: #000; margin-top: 8px; margin-bottom: 8px; margin-left: 10px; font-weight: 400;">
			<span> <a>欢迎来到 ${Session.user.username}个人中心</a>
			</span> <span>
				<button id="writeBlog">编写博客</button>
			</span>
		</div>
								...
								columns : [ [
										...
										},
										{
											...
											formatter : function(value, row,
													index) {
												var html = "";
												html += '<a href="#"  attrid="' + value + '" class="btn detailbtn"> 详情  </a>';
												return html;
											}
										} ] ],
