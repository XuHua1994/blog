...
(function($) {
	$.pager1 = function(option){
		...
		if(count>0){
				/*************page right*************/
			var $pager_right = $('<div><span class="span_l">到第</span><input type="text" class="text"/><span class="span_l">页</span></div>').addClass("right");
			
			var $go = $('<button type="button" id="go_page" class="general1">GO</button>');
