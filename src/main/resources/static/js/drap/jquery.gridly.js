...
(function() {
  ...
  Draggable = (function() {
    ...
    Draggable.prototype.began = function(event) {
      ...
      this.$target.removeClass("isMoving");
      this.x = this.coordinate(event).pageX;
      this.y = this.coordinate(event).pageY;
      this.origin = {
    ...
    Draggable.prototype.ended = function(event) {
      ...
      event.preventDefault();
      event.stopPropagation();
      if (Math.abs(this.x - this.coordinate(event).pageX) != 0 || Math.abs(this.y -  this.coordinate(event).pageY) != 0){
      	this.$target.addClass("isMoving");
      }
