...
function(e, t) {
    ...
    l.pt.vessel = function(e, t) {
        ...
        function() {
            ...
            for (var t = 0,i = r.btn.length; t < i; t++)e += '<a class="' + s[6] + t + ' normal" id="btn_ok_'+t+'" >' + r.btn[t] + "</a>";
            return '<div class="table-bottom-container"><div class="table-bottom-left"></div><div class="table-tottom-middle"><div class="' + s[6] + " layui-layer-btn-" + (r.btnAlign || "") + '">' + e + '</div></div><div class="table-bottom-right"></div></div>'
